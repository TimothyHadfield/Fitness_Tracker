...
**Tests: 3,433 across TWELVE suites**, recounted 2026-08-30 — data-layer **1750**, render **686**,
...
├── tests/
│   ├── data-layer.test.mjs     1750 assertions, no dependencies. Also holds the
...
│   └── render.test.mjs         686 jsdom assertions — mounts every screen
