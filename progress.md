...
**Tests: 3,378 across TWELVE suites**, recounted 2026-08-30 — data-layer **1728**, render **653**,
...
├── tests/
│   ├── data-layer.test.mjs     1728 assertions, no dependencies. Also holds the
...
│   └── render.test.mjs         653 jsdom assertions — mounts every screen
