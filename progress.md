...
**All nineteen no-Chrome suites are green — 5,393 assertions**, `render` **1,595** (from 1,579).
...
🆕 **WHERE 2026-09-20 STOPPED.** Four passes, all finished. **Nothing left half-done.**
