...
**The assessment he asked for is a section of its own below** ("HOW TO RANK ABS"). It was delivered;
he then sent an unrelated instruction about privacy defaults and never came back to it, so **the
choice is still his and nothing is built.** ⚠️ **Do not start building any of it.** If he raises it,
the three options and their costs are written out; if he does not, leave it alone.

⚠️ **THIS UN-DEFERS THE OLD "skip the abs" NOTE further down this file.** He deferred it on
2026-09-01 and re-opened it himself on 2026-09-03. The 2026-09-01 finding underneath is still exactly
true and is what option (a) fixes.
...
5. 🚨 **AND A FRIEND ON THE OLD MODEL IS STILL READABLE** — reported by Tim within minutes of the
   ...
   reader falls back to the tier documents. See the section below; it is the 2026-08-28 "her data is
   lost" incident arriving through a migration instead of through a publish.
...
**The most recent session is the 2026-09-03 sections below** — the visibility rewrite, the friend's
tappable map and the compare screen, the public default, the legacy-read fallback, and the abs
assessment. The four 2026-09-02 sections under them are the one before it (the Hevy-shaped feed,
Rule 8, the estimator), and the 2026-09-01 section under those is the one before that.
