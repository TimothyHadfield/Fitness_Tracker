...
6. ~~**Social — BUILT, and never used by two real accounts.**~~ 🚨 **THIS ITEM WAS THE MOST
   ...
   ✅ **Where it actually stands.** Phases 1–3 shipped 2026-08-18 (tiers, the projection builder, the
   rules, invite links, a friend's page). The two-account round trip ran 2026-08-22. The Hevy-shaped
   feed, the per-session workout screen, comparison, copy-as-routine and the shareable image all
   shipped 2026-09-02. **What is unverified is Tim's phone, and a live two-account run of everything
   built since 2026-08-29 — Open work item 1, and it has not moved in two sessions.**
