...
```bash
node tests/data-layer.test.mjs     # 1169 assertions, no dependencies
npm i jsdom && node tests/render.test.mjs
```

Eleven suites, 2369 assertions. Only `render` needs anything installed. `progress.md` lists the rest,
