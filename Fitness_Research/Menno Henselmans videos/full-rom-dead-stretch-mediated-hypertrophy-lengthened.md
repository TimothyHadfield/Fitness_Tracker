# Full ROM Is Not Dead: Stretch-Mediated Hypertrophy, Read Carefully

**Source:** Menno Henselmans, "Full ROM is dead? Stretch-mediated hypertrophy and lengthened partials" ([watch](https://www.youtube.com/watch?v=iVpvIen2WXQ)) · 2023-11-04 · 14 min
**Topic:** Training

## Bottom line
- Despite the title, his answer is **no**. His teaching principle is unchanged: **train with full range of motion, especially when the extra range increases muscle lengthening.**
- ROM is **degrees of joint angle**, not distance travelled. What drives growth is **functional excursion** — the percentage of the muscle's available lengthening you cover.
- Total tension = **active + passive tension**. Passive tension rises with length and is sensed by titin; this is the working mechanism for stretch-mediated hypertrophy.
- **Lengthened partials beat full ROM only in a narrow case**: exercises that load the stretched position poorly (leg extension, calf raise), and so far **only in untrained subjects**.
- Full ROM has a non-hypertrophy advantage he weighs heavily: **a measurable endpoint**. "Half a leg extension" cannot be tracked.
...
[04:36] The extreme demonstration: loaded static stretching alone — a calf orthosis pulling the calves into maximal stretch for **an hour a day** — produced growth comparable to roughly **15 sets of calf raises per week**.

**Flag:** he presents this as holding "even in trained individuals," but the loaded-stretching literature is small and the protocol brutal enough that generalising it to trained lifters is a stretch in both senses.
...
- His lengthened-partials claim is **considerably more conservative than the position usually attributed to this literature**. He does not claim partials beat full ROM generally — only for stretch-poor exercises, only in untrained subjects, and by a mechanism (more load for the same reps) that would fail under equated load.
- He concedes the mechanism is unresolved: passive tension via titin is "the best working theory," not established.
- This lecture predates the trained-subject lengthened-partial trials, including the null results, so the "untrained subjects only" caveat is the live edge of his position rather than a settled boundary.
