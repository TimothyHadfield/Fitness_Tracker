# Training Through Pregnancy: What the Evidence Actually Covers, and Where It Runs Out
...
- The "heavy lifting cuts off the baby's blood supply" fear is answered by **two small acute physiological studies**, not outcome trials: a Valsalva-vs-no-Valsalva haemodynamic study, and a **22-woman** 3D Doppler study finding no fall in placental blood flow during near-maximal chest press. Reassuring about the proposed *mechanism*; not evidence about outcomes months later.
- Guidelines say **moderate intensity, RPE 4–6**. The article's practical summary prescribes **RPE 6–8** for lifting, borrowed from a **non-pregnant** low- vs high-load meta-analysis. They flag the population, but the jump is clinical judgement, not a finding.
- They correctly report that guideline intensity caps reflect **absence of research at higher intensities, not demonstrated harm**, and that many listed contraindications are **expert opinion rather than evidence of harm** (Meah 2020, a systematic review framed explicitly as a "call to action").
- **The article's stop list is empty.** The sentence introducing "a few conditions where exercise should be stopped" is followed by nothing, and there is no warning-signs list (bleeding, leaking fluid, regular contractions, chest pain, calf swelling). For a safety guide that is its most consequential gap. They also sell coaching and dietitian consults, and link both.
...
Two intensity numbers sit in this article and they do not match.

**What the guidelines say.** Moderate intensity: **RPE 4–6** on a 1–10 scale, **3.0–5.9 METs**, heart-rate zone 2, and by talk test the point where you speak in short broken sentences. At least **150 minutes/week** of moderate conditioning, and resistance training **at least two days per week** on large muscle groups. Cited to the Canadian guideline, the scoping review, ACOG, the US guidelines, and ACSM's textbook for the MET definitions.
...
**Heat.** Extremes of core temperature from fever, hot tubs and saunas are associated with **first-trimester neural tube defects** (via ACOG); exercise is argued not to reach that range. The supporting study, **Carmichael et al. 2002**, is observational, finding activity associated with a **30–50% lower NTD risk** — vulnerable to confounding by who exercises. The 90°F/32°C and 60% humidity thresholds come from a National Weather Service page listed in the references but attached to no marker.

**Diastasis recti.** Prevalence given as **66–100%** to some degree, resolution ranging from spontaneous to persisting for years. The headline figure — **90% of non-exercising pregnant women with separation ≥2 cm versus 12.5% of the exercising group** — comes from a **single 2005 non-randomised study in a physical therapy journal** (Chiarello et al.), reported with no sample size, and that same study is the sole source for the mechanism and functional-deficit claims. The conclusion drawn — progressive abdominal training belongs in a pregnancy programme, with an exercise table attached — is reasonable clinical inference, but inference on one small old paper.

**Falls, contact and environment.** Avoid contact sports, downhill mountain biking, and exercises causing forcible abdominal contact — and credit to the article for saying outright that this is **anatomical and anecdotal reasoning, not research evidence**. Scuba diving is out, and altitude above **2,500 m** should be avoided by women living below it, acclimatised women above **1,800 m** possibly exempt (Canadian guideline, ACOG).

## Decision 4: what to actually stop for

This is where the article fails on its own terms. The setup is correct: **Meah, Davies & Davenport 2020**, a BJSM **systematic review of evidence of harm** subtitled a call to action, found that many absolute and relative contraindications in pregnancy guidelines rest on **expert opinion rather than demonstrated harm from exercising, or benefit from stopping**. The article then writes "There are a few conditions that emerging evidence and existing guidelines suggest exercise should be stopped until the condition is managed:" — **and lists nothing.**
...
The framing is that **how** you return matters more than **when**, sourced to **Deering et al. 2024**, an **international Delphi study and consensus statement** on postpartum return-to-running. A Delphi is structured expert opinion, not data, and the article does not say so.

The rest is guideline synthesis: the "fourth trimester" is the first 12 weeks, though a **2024 review of 22 postpartum guidelines** suggests the window may extend to a year, particularly for breastfeeding women. The article pushes back on the common **6-week wait** as not clearly evidence-based, citing ACOG's position that activity may resume as soon as medically safe — for some women within days. Their staged table (pelvic floor and abdominal drawing immediately; light walking and strengthening as tolerated at 2–6 weeks; progressive return after the postpartum assessment) is assembled from ACOG plus that review, not a validated protocol. The FAQ claim that exercise **does not impair milk production** is uncited.

## Evidence ledger, and what they sell

**Strongest:** Prevett et al. 2025, a large recent BJSM systematic review and meta-analysis directly on resistance training in pregnancy. Then Gould and Meah: small acute studies, but they test the exact mechanism the central fear rests on.
...
- Bhattacharyya M, et al. Disparities in adherence to physical activity guidelines among US adults: a population-based study. *Medicine* 2024;103:e39539. [doi](https://doi.org/10.1097/MD.0000000000039539)
- Nascimento SL, et al. Physical activity patterns and factors related to exercise during pregnancy: a cross-sectional study. *PLOS ONE* 2015;10:e0128953. [doi](https://doi.org/10.1371/journal.pone.0128953)
- Evins C, et al. Exercise counseling in pregnancy: do women perceive receiving the information they need? *Am J Lifestyle Med* 2021;15:441-452. [doi](https://doi.org/10.1177/1559827621991851)
- Yamamoto A, McCormick MC, Burris HH. US provider-reported diet and physical activity counseling to pregnant and non-pregnant women of childbearing age during preventive care visits. *Matern Child Health J* 2014;18:1610-1618. [doi](https://doi.org/10.1007/s10995-013-1401-z)

**Benefits for the exercising mother / Benefits for the child**
- DiPietro L, et al. Benefits of physical activity during pregnancy and postpartum: an umbrella review. *Med Sci Sports Exerc* 2019;51:1292-1302. [doi](https://doi.org/10.1249/MSS.0000000000001941)
- ACOG Committee Opinion No. 804. Physical activity and exercise during pregnancy and the postpartum period. *Obstet Gynecol* 2020;135:e178-e188. [doi](https://doi.org/10.1097/AOG.0000000000003772)
- Prevett C, et al. Resistance training in pregnancy: systematic review and meta-analysis of pregnancy, delivery, fetal and pelvic floor outcomes and call to action. *BJSM* 2025;59:1173-1182. [doi](https://doi.org/10.1136/bjsports-2024-109123)
- Panagiotidou A, et al. The effect of maternal diet and physical activity on the epigenome of the offspring. *Genes* 2024;15:76. [doi](https://doi.org/10.3390/genes15010076)

**Common concerns with exercise during pregnancy** — ACOG 2020 (above), for the minimal-risk and no-increased-risk statements, plus:
- Berghella V, et al. Exercise in pregnancy! *Am J Obstet Gynecol* 2017;216:335-337. (unresolved in the citation record)

**Is lifting weights safe for my baby? / Can I hold my breath?**
- Meah VL, et al. Cardiac responses to prenatal resistance exercise with and without the Valsalva maneuver. *Med Sci Sports Exerc* 2021;53:1260-1269. [doi](https://doi.org/10.1249/MSS.0000000000002577)
- Gould S, et al. Resistance training does not decrease placental blood flow during Valsalva maneuver: a novel use of 3D Doppler power flow ultrasonography. *Sports Health* 2021;13:476-481. [doi](https://doi.org/10.1177/19417381211000717)
- Moolyk AN, et al. Maternal and fetal responses to acute high-intensity resistance exercise during pregnancy. *BJSM* 2025;59:159-166. [doi](https://doi.org/10.1136/bjsports-2024-108804)
- Prevett 2025 (above) — the 47,619-participant pooled safety claim.

**Is it too hot for my baby?** — ACOG 2020 (above), for fever/sauna/hot tub and first-trimester neural tube defects, plus:
- Carmichael SL, et al. Physical activity and risk of neural tube defects. *Matern Child Health J* 2002;6:151-157. [doi](https://doi.org/10.1023/a:1019722011688)

**Other risks to the baby & things to avoid** — with ACOG 2020 (above):
- Mottola MF, et al. 2019 Canadian guideline for physical activity throughout pregnancy. *BJSM* 2018;52:1339-1346. [doi](https://doi.org/10.1136/bjsports-2018-100056) — scuba diving, altitude.

**Diastasis recti & exercise**
- Chiarello CM, et al. The effects of an exercise program on diastasis recti abdominis in pregnant women. *J Womens Health Phys Ther* 2005;29:11-16. [doi](https://doi.org/10.1097/01274882-200529010-00003) — sole source for the whole section.
...
**Aerobic and anaerobic conditioning / METs / RPE / The Talk Test** — Mottola 2019, Hayman 2023, ACOG 2020 and US PAG 2018 (above) carry the 150 min/week and RPE 4-6 targets, plus:
- American College of Sports Medicine. *ACSM's Guidelines for Exercise Testing and Prescription*, 11th ed. Wolters Kluwer, 2022 — MET definitions and examples.
- Scherr J, et al. Associations between Borg's rating of perceived exertion and physiological measures of exercise intensity. *Eur J Appl Physiol* 2013;113:147-155. [doi](https://doi.org/10.1007/s00421-012-2421-x) — cited for the Borg 13-15 range and, less appropriately, for talk-test validity.
...
- Persinger R, et al. Consistency of the talk test for exercise prescription. *Med Sci Sports Exerc* 2004;36:1632-1636.
