...
**Exposures.** Strength came from an isokinetic dynamometer — three warm-up reps, then three maximal contractions at 60°/s, gravity-corrected peak taken. Engagement in strengthening activity came from two NHANES questions about "any physical activities specifically designed to strengthen your muscles, such as weight lifting, push-ups, or sit-ups" in the past 30 days; **eight or more sessions in the month** counted as engaged. Only **382 people (13.8%)** cleared that bar; 1,009 (36.4%) met aerobic guidelines.

**Adjustment** was extensive: age, race, sex, self-reported aerobic activity, cholesterol, mean arterial pressure, BMI, CRP, smoking, ambulatory aids, statins, arthritis, heart failure, coronary artery disease, prior cancer, diabetes and stroke.

**Robustness checks.** No interaction between strength and age, sex, baseline cancer history, body mass or aerobic activity. Excluding the 394 participants ever diagnosed with cancer, the association held: **HR 0.43 (95% CI 0.22–0.84)**. Flipping the analysis to compare the *bottom* quartile against the upper three, the result was **no longer significant**.

## Where the interpretation outruns the design

**The measurement asymmetry is the central problem, and it is unaddressed.** A once-measured continuous physiological variable will beat a 30-day binary self-report on almost any outcome, purely through differential measurement error attenuating the self-reported exposure toward the null. That mechanism alone can generate the headline contrast without any of the biology it claims. Baraki lists self-report as a limitation but does not connect it to the conclusion built on top of it. With only 13.8% classified as engaged, the null on activity is also badly underpowered.

**A non-significant flipped analysis is not evidence of no effect.** The bottom-quartile comparison uses a smaller contrast and fewer events; failing to reach significance there does not establish that "simply avoiding the bottom quartile is not enough," which is how the article reads it.

**The PAF assumes what the design cannot show.** "One out of every five cancer deaths could have been averted" is called theoretical, and the word does a lot of work: attributable fractions computed from observational hazard ratios inherit every unmeasured confounder. Strength at 50+ is a good marker of general robustness, and reverse causation from subclinical disease is only partly handled by excluding prior diagnoses.

**Two citation blemishes.** The women's per-15 N result is printed as "HR 0.92, 95% CI 0.86-0.91" — an interval excluding its own point estimate, so a transcription error. And the opening claim about new cancer therapies giving "small, incremental survival benefits… at great cost" links to Prasad 2015 in *Blood*, which does not appear in the reference list at all. Ruiz is labelled "Ruiz 2010" while the paper is *BMJ* **2008** — a mislabel only; it does report cancer mortality, so it supports its sentence.

## What the article gets right

The clinical framing is better sourced than the headline. **Cachexia is well recognised by oncologists; sarcopenia in earlier-stage disease is not** — and the numbers are concrete: Burden 2010 found **54% of newly diagnosed early-stage colorectal cancer patients** had handgrip strength below 85% of the age-matched reference; Cao 2010 found **714 newly diagnosed patients carried 0.9 kg less muscle on average** than healthy controls *before* treatment. The mechanism offered — tumour-derived inflammation, drug effects, inactivity and malnutrition combining into **anabolic resistance** — is standard and labelled as complex.

He is explicit about what is unknown: the mechanisms linking strength to cancer outcomes "remain poorly understood," and **"exactly how strong is strong enough… remains unknown."** He also flags that **response to training varies widely between people** (Ahtiainen 2016), so someone starting weak and responding poorly could stay in the high-risk group despite doing everything asked.

**Recommendation versus evidence.** Starting resistance training and nutrition support **early**, before anabolic resistance becomes refractory cachexia, is clinical judgement. Its citations are a narrative review (Montalvo 2018) and a supplement review on advanced cancer (Antoun 2018), not trials with mortality endpoints. The closing line — "we can still feel confident in recommending strength training interventions to patients with cancer to reduce their risk of mortality" — is a stronger claim than one observational analysis supports, and is offered as clinical confidence rather than as a finding.
