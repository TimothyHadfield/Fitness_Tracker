# Varying Rep Ranges Is Fine, But It Does Not Build More Muscle

**Source:** House of Hypertrophy, "Alternating Rep Ranges IMPROVES Muscle Growth?! (18 Studies)" ([watch](https://www.youtube.com/watch?v=V40pAXOyuGc)) · 2021-03-08 · 12 min
**Topic:** Load & reps

## Bottom line
- The three studies with **MRI or ultrasound** measurement all found varied rep ranges produced the same hypertrophy as a constant rep range. Nothing supports rotating rep ranges as a growth strategy in the short term.
...
The second theoretical case is that different rep ranges impose different mixes of metabolic and mechanical stress, and might therefore activate different signalling proteins upstream of muscle protein synthesis. Some studies find low and high reps activate different proteins; others find they do not. He calls this unclear and moves on rather than building on it — which is the right handling, since even a confirmed signalling difference would be an acute surrogate rather than a growth outcome.

## The studies that measured muscle properly
**Schoenfeld** split 19 men averaging 4.5 years of training into constant and varied groups, training three times weekly for eight weeks: bench press, overhead press, lat pulldown, cable row, back squat, leg press and leg extension, 3 sets each, 2 min rest. Constant used 8–12 reps to failure every session. Varied used 2–4 reps on day one, 8–12 on day two, and 20–30 on day three. Ultrasound-measured elbow flexor, triceps and vastus lateralis thickness increases were statistically similar.

He then does something unusually careful: rather than stopping at "not significant", he goes to an article by James Krieger, one of the study's authors, examining the individual data. The triceps result numerically favoured the varied group and survived removal of one clear outlier; the biceps advantage disappeared after removing an outlier from the constant group; the vastus lateralis was similar throughout. His read — that the triceps result is most likely random variation in a 19-subject trained sample where genetics and training history differ — is stated as a judgement, not a finding.

**De Souza** split 26 untrained men into constant, linear and daily-undulating groups, training Smith machine squat and leg extension twice weekly for six weeks. Constant: 8 reps to failure. Linear: 12 reps for four weeks then 8 for two. Undulating: 12 and 8 in the first four weeks, 10 and 6 in the last two. MRI-measured quadriceps cross-sectional area increases were similar across all three.
...
This video cites its sources on screen only. The description carries no reference list, so no citation can be retrieved for it, and the studies below are **listed unverified** — author surnames are taken from the description's prose summary, where they are spelled out, rather than from the auto-captions. No PMIDs, journals or years can be confirmed from the available material.

**Fibre-type hypertrophy across rep ranges (unverified)**
- Grgic et al. — meta-analysis of five studies on fibre-type-specific hypertrophy with high vs low reps to failure.

**Varied vs constant rep ranges, MRI/ultrasound (unverified)**
- Schoenfeld et al. — 19 trained men, 8 weeks, constant 8–12 vs daily-varied 2–4 / 8–12 / 20–30, ultrasound.
- De Souza et al. — 26 untrained men, 6 weeks, constant vs linear vs daily undulating, MRI quadriceps CSA.
- Fink et al. — 21 untrained men, within-subject arms, 8 weeks, 80% vs 30% vs alternating blocks, MRI elbow flexor CSA.

**Varied vs constant rep ranges, body composition measures (unverified)**
- Kraemer et al. — 27 untrained women, 9 months, constant 8–10 vs varied 4–6 / 8–10 / 12–15, fat-free mass by skinfold calipers.

**Individual-data reanalysis (unverified)**
- James Krieger — an article reanalysing the individual subject data of the Schoenfeld study. No URL was given.
