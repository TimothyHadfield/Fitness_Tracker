...
He then does something unusually careful: rather than stopping at "not significant", he goes to an article by James Krieger, one of the study's authors, examining the individual data. The triceps result numerically favoured the varied group and survived removal of one clear outlier; the biceps advantage disappeared after removing an outlier from the constant group; the vastus lateralis was similar throughout. His read — that the triceps result is most likely random variation in a 19-subject sample — is stated as a judgement, not a finding.
