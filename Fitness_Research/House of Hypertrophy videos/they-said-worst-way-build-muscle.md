...
- **Isometric leg:** max-effort knee extension, **30 seconds per set**, RPE 10. Force output declined through the set as fatigue accumulated despite continued maximal effort. Knee bent as far as possible, averaging **~125° of flexion** — a long muscle length.
- **Dynamic leg:** knee extensions through **125° to 10° of flexion**, also **30 seconds per set**, load adjusted each set so subjects reached or nearly reached momentary failure. Average RPE ~9.
