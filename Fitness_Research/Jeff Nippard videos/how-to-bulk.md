# How to Bulk Properly: Rate of Gain, Calories, Macros and Training
...
- **Rate of gain is what determines fat gain.** Target **1-2% of bodyweight per month as a beginner, 0.5-1% per month as an intermediate/advanced lifter.**
- **A 5-10% caloric surplus is enough.** Dirty bulks running 50-100% over maintenance just fill fat stores without drug assistance.
- **Protein 0.7-1 g per lb of bodyweight. Fat 20-30% of total calories. Carbs fill the rest.**
- Train harder, not less, on a bulk — the extra calories only become muscle if the stimulus is there. Do cardio; it helps you tolerate volume.

## Why a surplus helps [02:03]
...
How much fat you gain depends mainly on how fast you gain weight. Muscle growth cannot be force-fed; gain too fast and the majority of it is fat.

**Scientific consensus for lean bulking:**
- **Beginner: 1-2% of bodyweight per month.**
- **Intermediate/advanced: 0.5-1% of bodyweight per month.**

Worked example: 2 years of training at 170 lb → about **1-2 lb per month**, so a full-year bulk yields **12-24 lb**.

Expected composition: closer to a beginner (especially with good genetics), potentially **100% of the gain can be lean**. Closer to your natural limit, expect roughly **half lean, half fat** — which Jeff considers acceptable, since the alternative is spinning your wheels. You can cut afterwards and, provided you **cut relatively slowly, train smart and eat enough protein**, retain most of the new muscle.
...
If you do not know your maintenance: **multiply bodyweight in pounds by 14 to 18** for a ballpark.
...
**Carbs: fill in all remaining calories.**
...
- Evening: flexible — pita, burrito, sushi, Thai, or often chicken, potato, sour cream, broccoli with roasted sunflower seeds for fats.
- Pre-bed: Greek yogurt, honey, peanut butter, side of popcorn; leftover calories sometimes spent on candy or chocolate.

Tracking macros is what buys the flexibility — junk food is fine within daily totals.

## Training on a bulk [08:44]

The biggest mistake is slacking off in the gym while eating more, which guarantees fat over muscle. Training is what triggers growth; diet only supports it.

**Beginner (first year):** focus on the basics — proper technique on the main exercises and learning to push hard with good form. **Splits do not matter** (bro split, push/pull/legs, upper/lower, full body all work). Pick what you like; be in the gym **at least 3 days per week, with 4-5 days likely most optimal**.

**Intermediate (1-3 years of hard training):** add volume, but intensity is still the most important factor. **Around 8-15 sets per muscle per week.** Big complex muscles like the back tolerate more volume than, say, chest, so allocate accordingly. Also a good point to move off the bro split to avoid junk volume.

**Advanced (3+ years hard and smart):** consider a **specialisation program** — raise volume for just one or two muscles at a time by **20-40%**. Example: 15 sets per week for shoulders → **18-20 sets**. Lengthened partials, myo-reps and other advanced techniques can add marginal gains here.

## Cardio [10:46]

Yes, do it. "Cardio kills gains" rests on outdated, low-quality science. Good cardiovascular conditioning is healthy and **helps you tolerate more training volume** — if your conditioning is poor, your heart and lungs give out before your legs do on leg day and you leave reps on the table.

- Very active job (construction, serving): you may need no extra cardio.
- Desk job: you probably should do some.
- Jeff does **2-3 moderate-intensity sessions per week** — brisk walks or playing basketball.
...
1. Find maintenance (bodyweight in lb × 14-18, or track for two weeks), then add **5-10%**.
2. Set protein at **0.7-1 g/lb**, fat at **20-30% of calories**, carbs with the remainder.
3. Weigh yourself and hold the rate: **1-2%/month beginner, 0.5-1%/month intermediate+**. Adjust calories up or down if the rate is off.
4. Train harder than usual: 4-5 sessions per week, ~8-15 sets per muscle per week as an intermediate, specialisation blocks if advanced.
5. Keep 2-3 moderate cardio sessions weekly unless your job already covers it.
6. Creatine 5 g, protein powder, caffeine pre-workout; fish oil, magnesium and vitamin D as sensible extras.
7. Plan on a slow cut afterwards with high protein and hard training to keep the muscle.

## Caveats & unknowns
- The maingain vs bulk study's zero-fat-gain result is likely a beginner artefact; experienced lifters should expect fat gain alongside muscle.
