# The Science of Milk: Mortality, Cancer, Acne and the Anti-Dairy Arguments
...
- A 2017 meta-analysis of 29 studies and over 700,000 participants found no association between dairy/milk intake and all-cause mortality, coronary heart disease, or cardiovascular disease.
- Cancer data is mixed but net favourable: four cancers positively impacted, several neutral, only prostate cancer showing a possible adverse signal.
- 65-75% of people have some degree of lactose intolerance — a reason for individual assessment, not a blanket strike against dairy.
- Milk is nutritionally dense: protein, calcium, potassium, vitamin A, B12, plus effects on muscle mass and satiety.

## The weak anti-dairy arguments [00:31]
**"It's unnatural — humans are the only animal that drinks another animal's milk."** The premise is factually wrong: feral cats and, per the transcript, western gulls have been observed stealing milk from elephant seals in the wild. More importantly, the argument is irrelevant even if true — whether other species do something has no bearing on its effect on human health, and basing diets on what animals eat would produce strange recommendations. The appeal to nature fails in both directions: cyanide in apple seeds is natural and will kill you in sufficient quantity; man-made antibiotics are unnatural and will save your life.

**"Milk is acid-forming rather than alkalizing."** As Alan Aragon pointed out in a well-cited NSCA presentation, milk and dairy products do not produce acid upon metabolism — and systemic pH isn't influenced by diet in the first place. Dairy's bone-protective effect is supported by the majority of research.
...
- The only adverse outcome was prostate cancer risk — and even that was neutral-to-adverse depending on the dataset examined.

The authors concluded that the protective effect of milk and dairy on common, serious colorectal cancer outweighs the potentially increased prostate cancer risk.
...
- If milk consistently causes digestive issues, run an elimination diet to confirm dairy is the culprit, then limit intake to your own tolerance rather than cutting it entirely.
- Same approach for skin: if you suspect milk is worsening acne, eliminate and reintroduce to test. Yogurt and cheese may be fine even if fluid milk isn't.
- Don't avoid milk on the basis of the "unnatural" or "acidic" arguments — neither survives scrutiny.

## Caveats & unknowns
- The core mortality and cancer evidence is observational, so causation isn't established and confounding is plausible.
