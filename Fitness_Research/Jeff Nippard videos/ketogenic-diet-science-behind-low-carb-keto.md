# The Ketogenic Diet: What the Science Says About Fat Loss, Muscle and Health
...
- Both mechanistic arguments for keto — the insulin hypothesis and a metabolic advantage — fail experimentally.
- Keto's real effect is appetite suppression plus food-group elimination, both of which reduce calorie intake. Other, less restrictive strategies achieve the same thing.
- Match calories and protein and keto shows no advantage for strength or size, and a possible penalty for high-intensity and endurance performance.
...
## Claim 1: the insulin hypothesis [01:33]
...
Prolonged energy surplus, not any single hormone, drives fat gain.

## Claim 2: a metabolic advantage [02:34]
The argument: converting protein to glucose is energetically costly, so without dietary carbs the body "wastes" calories and loses more fat.

A 2013 review found no direct experimental evidence for a metabolic advantage, and a recent study reported no change in resting energy expenditure after a very low-carb ketogenic diet. The scientific community has pushed back hard and nothing has turned up in support.

## What keto actually does [03:35]
It suppresses appetite — an effect repeatedly noted in the literature. But carb restriction isn't the only route to that. Intermittent fasting improves hunger control regardless of carb intake, as do simple moves like raising water intake and raising fibre intake.
...
## Performance and muscle [10:42]
- Most trials favouring keto don't control protein, so the keto group winning is unsurprising.
- **Wilson and colleagues** matched both calories and protein and found **similar increases in strength and power** on a ketogenic diet versus a Western diet — suggesting keto is less ergolytic for strength training than for endurance training.
- **Burke and colleagues, 2015:** fat-adaptation strategies may impair exercise performance, particularly in shorter high-intensity events, likely because muscle glycogen utilisation needed for high work rates is impaired.
- Net: with calories and protein matched, no benefit for strength or size, plus a potential performance risk.

## Practical application
- If you want to run keto: carbs **under 50 g/day**, roughly 5% carbs / 20% protein / 75% fat, mostly fibrous carb sources.
- Prioritise **protein** whatever your carb intake — it beat normal protein in both carb conditions at 1 year and protects muscle.
- If your goal is appetite control, try intermittent fasting, higher fibre or higher water intake before cutting out a whole macronutrient.
- Expect the "keto flu": nausea and lethargy during the first few weeks of adaptation. It passes, but the barrier to entry is higher than for other diets and there's no obvious long-term payoff to justify it.
- If you're on keto and it's working, stay on it. Choose based on adherence, not mechanism.

## Caveats & unknowns
- Individual response varies; some people genuinely do well on keto long-term.
