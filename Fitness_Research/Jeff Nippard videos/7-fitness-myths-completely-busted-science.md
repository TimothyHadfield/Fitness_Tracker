# 7 More Fitness Myths Busted (Myth-Busting Season 1 Recap, Part 2)
...
- HIIT's afterburn is trivial (~80 calories from 80 minutes of work). Cap HIIT at 1-3 sessions per week and create further deficit through food or steady-state.
- Keto isn't magic: ~1 kg extra weight loss versus conventional diets in meta-analysis, which the authors themselves call not clinically significant. Adherence is what matters.
- "Knees shouldn't pass the toes" is false and counterproductive — blocking knee travel just shifts load to hips and low back.
- Alcohol blunts fat oxidation and can cut post-workout MPS by up to 37%, but moderate intake with calories and protein controlled won't wreck you.
...
**Verdict: busted.**
[01:33] The purported EPOC/afterburn benefit is tiny. A 2006 research review by Lyle McDonald found that a full 80 minutes of HIIT produced only about **80 extra calories** burned via EPOC, and more recent data across 28 studies downplayed the effect further. Other research argues HIIT is about 40% more time efficient, but that work isn't well controlled — the apparent efficiency could be appetite blunting or a placebo effect from feeling like you worked harder.

Pros: possibly more time efficient, less boring for some. Cons: harder to recover from so you can't do it as often as low-intensity work, more likely to interfere with resistance training, and potentially redundant if you already train weights intensely (similar systems, similar adaptations).

**Recommendation: limit HIIT to 1-3 sessions per week and create any further caloric deficit through reduced food intake or steady-state cardio.**
...
## 4. Fresh produce is more nutritious than frozen
**Verdict: busted as a blanket rule.**
[04:38] It depends entirely on the food. Beta carotene is higher in fresh broccoli than frozen, but lower in fresh corn than frozen. Rickman and colleagues note that nutrient loss during fresh storage may be more substantial than consumers realise, and depending on the commodity, freezing and canning may actually preserve nutrient value. Dr. Steven Novella's summary is the takeaway: the most nutritious produce is the produce you'll actually eat — even the worst fruits and vegetables are more nutrient dense than other food types, so if affordable and convenient produce makes you eat more of it, that outweighs marginal nutrient differences.
...
- Don't use ice baths or cryotherapy as routine post-training recovery if hypertrophy is the goal; a 10-minute easy bike cooldown does as much. Save cold exposure for in-season competitive contexts where performance recovery outranks growth.
- HIIT: 1-3 sessions/week maximum, rest of the deficit from diet or steady-state.
- Choose a diet on adherence, not mechanism. Keto is a valid option, not a superior one.
- Buy frozen produce freely — it's often equal or better, and cheaper.
- Squat cues: heels down, bar over midfoot, knees out over toes. Let the knees travel.
- Skip apple cider vinegar unless you're targeting blood glucose and already insulin resistant. Never use it on your teeth.
- Drinking heavily? Drop dietary fat that day, keep protein up, don't binge on the way home.
