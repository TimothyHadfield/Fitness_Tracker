# The Post-Workout Anabolic Window: How Wide It Really Is
...
- Eating carbs purely to refill glycogen is unnecessary — high-intensity resistance training at moderate volume only depletes glycogen by **36–39%**, easily replenished by any carbs eaten in the following 24 hours.
- Eating carbs to spike insulin is equally pointless: the insulin rise needed to suppress muscle protein breakdown is achieved by protein alone or a simple mixed meal.
- Slamming high-glycaemic carbs post-workout mostly supplies empty calories.

## Practical application
- Prioritise **total daily protein** first. Timing is a rounding error by comparison.
- Aim to eat protein within a few hours either side of training. Anywhere in that 4–6 hour band is fine.
- **Trained fasted, or last meal 2–3 hours ago?** Get protein in within about an hour after.
- **Ate protein 1–2 hours pre-workout?** You have several hours of slack; eat when convenient.
- Advanced athletes chasing every morsel: eat protein as soon as possible after training. Everyone training for general size and shape: stop worrying about it.
- Do not bother with a dedicated high-glycaemic carb drink for hypertrophy.
