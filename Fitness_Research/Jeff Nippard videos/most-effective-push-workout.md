# Science-Based Push Workout #2: Shoulder-Led Chest, Delts and Triceps
...
- Don't repeat the identical session twice a week. Daily undulating periodization (varying reps, sets and exercises across the week) tends to produce better gains — beginners are the possible exception.
- Order the workout by weak point: whatever lags goes first, while you're fresh.
- Side delts get flooded with volume via a superset using two different resistance curves; triceps get one isolation movement because they're already hammered by the presses.
- Volume shown is aimed at intermediates. Advanced lifters add a few sets or an exercise; beginners cut 1-2 sets per exercise for the first few weeks.

## The routine

| # | Exercise | Sets × reps | Notes |
|---|---|---|---|
| 1 | Barbell overhead press | 4 × 6-8 | Belt + stable shoe |
| 2 | Close-grip bench press | 3 × 8-10 | Slow controlled tempo, moderate arch |
| 3 | Incline dumbbell fly (optional) | 3 × 10-12 | Only if chest is lagging |
| 4a | Rope upright row | superset | Elbows below shoulder height |
| 4b | Banded lateral raise | superset | Different resistance curve |
| 5 | One-arm overhead triceps extension | — | Long head focus |
| 6 | Medicine-ball push-up (finisher) | to RPE 8 | Aim 20-30 quality reps |

Swap exercises 1 and 2 if chest, not shoulders, is your weak point. Nippard alternates the priority session to session because neither lags for him.
...
**One-arm overhead triceps extension [06:39]** — The first push day used pressdowns (arms at sides), which bias the lateral head. The long head contributes more to overall triceps mass and needs an overhead position. Unilateral work prevents left-right imbalances. Grip your shoulder with the free hand to lock everything in place and stop yourself cheating. One triceps isolation per push day is enough given all the pressing; lagging triceps or advanced lifters can add a second movement for 2-3 sets.

**Medicine-ball push-up [07:09]** — A finisher hitting chest, shoulders and triceps together. Take it to RPE 8 (stop when you think two reps are left). Pick a rep target and add reps week to week; most should manage at least 20-30 controlled reps. There's literature showing an unstable base during push-ups increases triceps activation.

## Practical application
- Run this as the second push session of a PPL week, with a different push session (horizontal-press-led, heavier) earlier in the week.
- Set your first exercise by weak point, not habit.
- On the RDL-style progression logic applied here: on the finisher, add reps at fixed conditions rather than chasing load.
- Rotate resistance curves deliberately across the week — free weights for stretch, cables for constant tension, bands for peak-contraction overload.
- Scale the total volume: beginners -1 to -2 sets per exercise; advanced +a few sets or an extra movement.
