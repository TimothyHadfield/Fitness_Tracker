# How Alcohol Influences Muscle and Fat Gain (10 Studies)
...
- The testosterone panic is overblown — the data is mixed, and the effect sizes are too small to matter for physique outcomes.
- The real cost is **muscle protein synthesis**: alcohol suppressed post-workout MPS by **37%**, reduced to **24%** when protein was consumed alongside it.
- The bigger practical cost is the **next day's training quality**, not the drinking itself.
...
- **Binging on high-fat food after drinking is the worst-case scenario** — that fat is very likely to be stored, far more readily than if you had not drunk at all.
- Common misconception corrected: **alcohol itself is not readily stored as fat.** The problem is that the *other* calories you eat, especially fat calories, become much more likely to be stored while alcohol is present.

## Two ways to drink without gaining fat [04:10]
**1. The tracking method.** Track calories as normal for the day, **borrow the alcohol calories from fat (ideally) or carbs**, and make your total daily calorie and protein targets add up.
...
This is where the data is consistent, not mixed. MPS is suppressed by alcohol, especially post-workout. Most research is in mouse models, but they consistently show the same negative effect. The main high-quality human paper, **published 2014 (author garbled — most likely "Parr et al.", verify before citing)**, found:
- Alcohol **inhibited post-workout MPS by 37%**.
- That inhibition fell to **24%** when **protein was consumed alongside the alcohol** after training.

So protein **partially but not fully rescues** the effect. His judgement: a ~24% MPS reduction for a handful of hours is **not significant enough to outweigh the next-day training detriment**, which is the larger concern.

## Practical application
- **Fit alcohol into a deficit** and fat gain is a non-issue.
- **Take the calories out of fat**, keep protein high.
- **Consume protein with or after the alcohol** post-workout — it cuts the MPS hit from 37% to 24%.
- **Know your personal limit**, the dose past which the next day's training suffers.
- If you cross that line, you have two options: accept a **subpar workout** the next day, or — the option he prefers — **plan a rest day** the day after drinking, and spend it recovering and rehydrating. Forcing a bad session you will recover poorly from can degrade subsequent workouts too.
