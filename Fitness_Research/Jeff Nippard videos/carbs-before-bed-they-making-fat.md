# Carbs Before Bed: Do Late-Night Carbs Make You Fat?

**Source:** Jeff Nippard, "CARBS BEFORE BED: Are They Making You Fat? (What The Science Says)" ([watch](https://www.youtube.com/watch?v=fD79Udsr7OQ)) · 2018-02-13 · 10 min
**Topic:** Nutrition

## Bottom line
- Busted. There is nothing about eating carbs after 6-7 pm that promotes fat storage.
- Metabolic rate during sleep is essentially identical to resting metabolic rate while awake (sleep:awake ratio ≈ **1.0011**).
- Body composition is driven by **24-hour (and longer) net calorie balance**, not transient hour-to-hour swings in metabolism or insulin sensitivity.
- Dietary carbohydrate is rarely converted directly to body fat in humans (de novo lipogenesis is uncommon under normal eating).
- Meta-analytic evidence finds no significant weight-loss advantage to a smaller evening meal.

## Theory 1: metabolism slows at night
Total daily energy expenditure (TDEE) has four components:
- **RMR** (resting metabolic rate) — roughly **half** of TDEE; what you'd burn lying on the couch all day.
- **EAT** — exercise activity thermogenesis.
- **NEAT** — non-exercise activity thermogenesis (walking to the shops, fidgeting).
...
## Two further reasons the premise fails
1. **Transient shifts don't determine body composition.** Even if nutrients eaten at night were preferentially partitioned toward storage, that energy comes back out of storage as long as a net deficit exists across the day. Net caloric deficit is the driver.
...
- Appetite patterns are highly individual. If you have little appetite in the morning and more at night, skewing intake later is fine and costs you nothing.
- The one legitimate use of a nighttime cut-off is **behavioural**: if late-night snacking is what breaks your deficit, setting a time after which the kitchen is closed is a pragmatic tool — not a metabolic one.
