# Warming Up and Mobility: Why It Works and a Three-Stage Protocol

**Source:** Jeff Nippard, "Warm Up and Mobility Science Explained (7 Studies)" ([watch](https://www.youtube.com/watch?v=r2I4CrDlL3o)) · 2017-02-18 · 7 min
**Topic:** Recovery

## Bottom line
- Two solid reasons to warm up: modest injury reduction and improved performance. The evidence for injury prevention is weak-but-positive; the performance evidence is stronger.
- The core of the warm-up is **raising body temperature** — exercise until light-to-mild sweating, roughly **5-15 minutes** of easy cardio at **55-60% max HR** (~100-120 bpm for a 20-30 year old).
- **Dynamic stretching is fine or helpful; long static stretching before lifting impairs performance.** Keep static holds under **30 seconds** per muscle and always follow them with dynamic work.
- Finish with a **specific warm-up**: pyramid loads up to your first working set.
...
1. **General warm-up:** ~10 minutes of cardio (treadmill, StairMaster or bike) to light sweating, ~55-60% max HR.
2. **Dynamic stretching and foam rolling:** 4-5 dynamic stretches for lower body on leg days, 4-5 for upper body on upper days. Any needed static stretching (e.g. groin, hamstrings) goes **before** the dynamic work, capped at **20-30 seconds** per stretch — or is moved to the evening before bed if the area needs real focus. Optional foam rolling, 20-30 seconds per tight spot.
3. **Specific warm-up with progressive loading:** pyramid up to your working weight. His bench press example — **bar × 10, 30% × 5, 50% × 4, 60% × 3, 70% × 2, 75% × 1-2**, then working sets.

## Practical application
- Do the 10 minutes of easy cardio first, every session, until lightly sweating.
- Static stretching is allowed if kept short and placed before dynamic work; never end the warm-up on a long static hold.
- Run the load pyramid only for the first exercise of the day; subsequent exercises inherit the warmed state.
