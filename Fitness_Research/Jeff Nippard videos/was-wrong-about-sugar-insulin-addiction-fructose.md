# Sugar Follow-Up: Insulin, Addiction, Insulin Sensitivity and Fructose
...
- Insulin from meals is **transient, not chronic**. Over 24 hours, lipogenesis and lipolysis cancel out at energy balance and net fat balance goes negative in a deficit, regardless of sugar.
- Sugar has **addictive-like qualities**, not true addiction. Rodent devaluation and taste-bud-knockout experiments point to palatability, not a pharmacological hook.
- Under **isocaloric** conditions, high-sucrose vs low-sucrose diets showed **no difference in insulin sensitivity over six weeks** in healthy subjects.
- Fructose is not "toxic". Isotope-labelling work suggests roughly half becomes glucose, roughly half becomes lactate, and **only about 1% is converted to fat** — holding even at intakes up to ~100–150 g.

## 1. The insulin argument [01:33]
Insulin's job is to move glucose out of the blood into muscle, liver and fat cells. It also **inhibits lipolysis** (fat breakdown) and **stimulates lipogenesis** (new fat formation). Those last two functions are why insulin — and by extension sugar, a potent insulin stimulator — gets blamed for making people fat.
...
## 3. Sugar and insulin sensitivity [08:17]
High insulin sensitivity — cells responding well to insulin and clearing glucose from the blood — lowers risk for diabetes, obesity and metabolic syndrome. Does sugar degrade it?
...
**On toxicity:** what makes something toxic is whether it has deleterious health effects, not where it's metabolised — and toxicity is always **dose-dependent**. Even botulinum toxin, more toxic than nerve gas or plutonium, is used cosmetically in Botox at tiny doses without harm. Fructose isn't toxic on anything like that scale, and the word is emotion-raising language used by anti-sugar advocates.

**On fat generation:** the claim is that ingested fructose goes to the liver, is converted into fat, is stored there, and drives fatty liver disease. Citing an interview with **Brad Dieter, PhD**, who has researched this field, Nippard describes radioactive-labelling work showing that on reaching the liver, roughly **half of ingested fructose is immediately converted to glucose**, roughly the **other half to lactate** and shipped out to other tissues, and only about **1% is converted to fat**. This holds even at very high doses — up to around **100–150 g** of fructose, which is a lot.

## Practical application
- Stop using insulin response as a food-selection criterion. Protein spikes it too; mixed meals blunt it; what matters is 24-hour energy balance.
- If you're in a calorie deficit, you will lose fat regardless of how much of it comes from sugar.
- Manage **hyper-palatable, highly processed, always-available foods** as an environment/availability problem, not an addiction problem. Moderating sugar intake is reasonable for some people on those grounds.
- **Best moves for insulin sensitivity:** exercise regularly; eat minimally processed whole foods rich in vitamins, minerals and fibre; put special emphasis on more fruit and vegetables.
- Cutting a daily two-litre soda is a genuine, worthwhile intervention — because of the overconsumption, not because sugar is toxic.

## Caveats & unknowns
- This is an informal walk-and-talk phone recording; Nippard names almost no studies, journals or authors beyond Brad Dieter, so most claims here cannot be traced to a specific citation from the transcript alone.
- He explicitly hedges on the claim that glucose is metabolised by every tissue ("correct me if I'm wrong").
