# The Four Worst Nutrition Mistakes Lifters Make
...
- Nutrition has a **permissive** role: training causes growth, food merely permits it.
- Protein target is 0.7-1.0 g per lb bodyweight (1.6-2.2 g/kg) in a surplus; 0.8-1.2 g/lb in a deficit. Above 0.7 g/lb the returns flatten sharply.
- Creatine is worth taking but is worth roughly 2-3 lb of lean mass, not a steroid-like transformation.
- Meal frequency: 1-6 meals/day is fine for fat loss; 3-6 protein-containing meals is probably slightly better for muscle growth than 1-2.
...
**Surplus targets [02:02]:**
- Faster muscle gain, comfortable with some fat: **10-20% surplus**
- Leaner bulk: **5-10% surplus**
- Prioritizing fat loss while still building: **slight deficit**

He does not condemn aggressive bulks outright — despite the short-term Garthe findings, his coaching experience is that more aggressive bulks do lead to more strength gain long term and let you take up more total space. But they make the subsequent cut much harder and usually aren't worth it for most people.
...
- In a deficit for fat loss: **0.8-1.2 g per lb**, to prevent muscle loss or even allow gain.

Nippard's own example while cutting: 150 g protein per day at 165 lb bodyweight, about 0.9 g/lb — sitting toward the lower end is perfectly fine. He only recommends the top of the range for someone very lean and at high risk of muscle loss.

**The break point [07:10]:** a systematic review from Morton and colleagues found muscle gain increases with protein intake only up to **0.7 g per lb**, where the trend hits a break point; above that, extra protein does little ([Morton 2018](https://pubmed.ncbi.nlm.nih.gov/28698222/)). Below it, you still build muscle — at 0.5 g/lb you would still grow, just more slowly. So if you can't afford or don't want a high protein diet, you can still make progress. The optimum is also well below what bodybuilding magazines have claimed for years.

## Mistake 4: misunderstanding meal frequency [07:40]
**For fat loss, the number of meals is up to you.** For some people one or two large meals in a time-restricted window makes cutting total intake much easier. For others, restricting the eating window lowers energy and makes hunger unmanageable, and four to six smaller meals spread through the day works better. When calories and protein are equated, the literature shows no approach is significantly better ([Schwingshackl 2020](https://pubmed.ncbi.nlm.nih.gov/32437566/)). So don't force six to eight meals a day to "speed up your metabolism" (it doesn't) and don't grind through intermittent fasting because it "burns belly fat" (it doesn't). Pick the pattern that helps you adhere.

**For muscle growth, frequency matters slightly [09:11]:** a 2021 study found no significant difference in muscle gained between three meals a day and six ([Taguchi 2021](https://pubmed.ncbi.nlm.nih.gov/33361498/)). A 2020 study found three meals a day trended toward more growth than two, with a fairly large effect size, though it did not reach statistical significance ([Yasuda 2020](https://pubmed.ncbi.nlm.nih.gov/32321161/)).

**Verdict:** 1-6 meals per day is fine for fat loss; **3-6 protein-containing meals per day is probably slightly better than 1-2 for muscle growth.** The two-meal group in the 2020 study still made gains, and the gap was not enormous.

## Practical application
Set calories by goal (5-10% surplus for a lean bulk, 10-20% if you accept fat gain, slight deficit to recomp), hit 0.7-1.0 g protein per lb (0.8-1.2 in a deficit), spread it over 3-6 meals, take creatine and use caffeine and protein powder for convenience — then stop optimizing nutrition and put the attention into training, which is what actually causes growth. Because calorie needs shift with metabolism, training habits and body composition, targets need updating over time rather than being set once.
