# Intermittent Fasting: What 14 Studies Actually Show

**Source:** Jeff Nippard, "The Science Behind Intermittent Fasting (14 Studies) | Nutritional Science Explained" ([watch](https://www.youtube.com/watch?v=Q1sfiDIPzHU)) · 2017-11-12 · 6 min
**Topic:** Nutrition

## Bottom line
- "Intermittent fasting" isn't a term the literature uses. The two studied protocols are **alternate-day fasting** (eat one day, fast the next) and **time-restricted feeding** (fast 16-20 h, eat in a 4-8 h window).
- Fasting genuinely blunts appetite, but the largest systematic review to date (40 studies) found that better hunger control **did not** translate into better weight loss or body composition versus ordinary continuous calorie restriction.
- Fears about muscle loss are unfounded at the timescales fasting protocols use — even 40 h of fasting didn't produce meaningful atrophy.
- The "6 meals a day to stoke metabolism" idea is wrong: the thermic effect of food scales with total calories eaten, not with how many meals you split them into.
- The one real argument against fasting is protein distribution — evenly spread doses appear better for muscle protein synthesis than one or two large ones.
...
- Structure: 16 h fast / 8 h window, meals arranged around training (LeanGains style), is the most common practical version.
- Try to fit roughly **four protein feedings of ~20 g or more** into the day; that's the parameter most compromised by a short window.
- Best candidates: people carrying more body fat, and people whose appetite and schedule genuinely suit fewer, larger meals.
- Poor candidates: adolescents; and lean people, in whom alternate-day fasting mostly produced weight maintenance.
- Expect 1-2 weeks of elevated hunger during the switch, then adaptation.
- Nippard's own conclusion: fasting hasn't demonstrated real superiority over a standard diet with a calorie deficit and sufficient protein. **The best diet is the one you adhere to best.** He doesn't practice full IF himself, though he uses breakfast skipping to push eating later in the day.
