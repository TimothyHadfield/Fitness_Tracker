# Protein for Muscle Growth: Daily Targets, Per-Meal Doses, Quality and Timing
...
- Spread it over **3-5 meals**. Distribution and total intake together deliver >90% of the achievable result.
- The "20-25 g per meal ceiling" is probably wrong — newer work shows 40 g beats 20 g and 70 g beats 35 g for muscle protein synthesis (MPS).
- Protein quality barely matters on a mixed diet hitting total needs. Vegans are the exception: eat toward the top of the range and/or use a high-leucine blend.
- The post-workout "anabolic window" is not 30 minutes. Pre- and post-workout meals within ~4-6 hours of each other is sufficient.
...
**Height shortcut for higher-body-fat lifters (via Eric Helms).** If overweight or obese, aim for **1 g of protein per centimetre of height** — 183 cm (6 ft) → ~183 g/day. Simpler than the older lean-body-mass sliding scale and works well at higher body fat. All ranges apply equally to men and women.

## How much protein per meal? [03:40]

Absorption is a red herring: the gut can absorb an enormous amount, far more than you could comfortably eat. Absorbed ≠ used for muscle. The real question is how much can be *used*.
...
## Protein quality: leucine and EAAs [05:13]

Leucine is the trigger for mTOR, which triggers new muscle growth. **~3 g of leucine per meal** is a decent ballpark for maximising the anabolic response.

- **Whey: 29 g of powder gives 3 g leucine for ~145 calories** — the most efficient source.
- **Chicken breast: 40 g of protein gives 3 g leucine for ~200 calories.**
- **Whole wheat bread: over 2,000 calories to reach 3 g leucine.**
...
Per the International Society of Sports Nutrition position stand, there is "no controlled scientific evidence indicating that increased protein intakes pose any health risks in healthy exercising individuals." Intakes far above the recommendations here — **as high as 4.4 g/kg (2 g/lb)** — have consistently reported no harmful effects, and higher protein intakes show health benefits.

## Practical application
1. Pick your target from your phase: bulk 0.7-1.0 g/lb, cut 0.8-1.2 g/lb, recomp same as bulk. If carrying a lot of fat, use 1 g per cm of height instead.
2. Split it across 3-5 meals. Do not stress about a per-meal cap; 40 g+ per feeding is fine and possibly better.
3. Get most protein from animal sources or a decent powder and forget about quality entirely — it takes care of itself.
4. Vegans: aim high in the range and/or use a pea + brown rice "vegan whey" blend.
5. Keep pre- and post-training meals within 4-6 hours. Train fasted → eat protein soon after.
6. Optional extra: ~40 g protein before bed, most worthwhile if you have a long overnight fast.

## Caveats & unknowns
- The usable per-meal maximum is genuinely unsettled — evidence points above 25 g but no clear number exists.
