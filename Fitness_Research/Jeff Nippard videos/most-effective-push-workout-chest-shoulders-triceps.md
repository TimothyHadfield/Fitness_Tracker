# Science-Based Push Workout: Chest, Shoulders & Triceps

**Source:** Jeff Nippard, "The Most Effective Science-Based PUSH Workout: Chest, Shoulders & Triceps (Science Applied Ep. 1)" ([watch](https://www.youtube.com/watch?v=LwHoNk-sjgs)) · 2018-02-10 · 13 min
**Topic:** Exercise Selection

## Bottom line
- One heavy compound press (bench), then isolation work chosen for activation: incline cable fly, standing dumbbell press, Egyptian lateral raise, triceps isolation, a loaded stretch finisher, and optional face pulls.
- Bench press is the anchor because it loads progressively, correlates with pec size, transfers to other pressing movements, and recruits chest, delts and triceps together.
- Standing dumbbell press is chosen over barbell/seated variants because EMG favours it for side delts while still hitting front and rear delts.
- Triceps get one arms-at-sides movement (lateral head) and one overhead movement (long head).
- The workout closes with a 60-second flat dumbbell hold at ~40% of your 4-6RM weight, progressed by adding time.

## The routine

| # | Exercise | Sets x Reps | Notes |
|---|---|---|---|
| 1 | Barbell bench press | **4 x 4-6**, straight sets | Same weight across sets, **RPE 7-8** (2-3 reps in reserve). Use a spotter. |
| 2 | Incline cable fly | as programmed | Bench at ~45°; cross hands over at the top |
| 3 | Standing dumbbell overhead press | as programmed | Chosen for side-delt involvement |
| 4 | Egyptian lateral raise | as programmed | Lean away, perform between the legs |
| 5 | Triceps isolation | **4 x 12-15** | Pick a pressdown *or* an overhead extension |
| 6 | Flat dumbbell hold | **2 x 60 s** | ~**40%** of your usual 4-6 rep working weight |
| 7 | Face pulls (optional) | **3 x 20** | Postural balance |

**Bench progression:** keep the load fixed and add reps until you hit 6 reps on all four sets, then add weight and start again at the bottom of the 4-6 range.

**Triceps rotation:** do one head-emphasis movement this push day and the other on your second weekly push day. If triceps are lagging, do both in the same session to raise weekly volume.

**Dumbbell-hold progression:** rather than adding reps or load, add **5-10 seconds** per week to the hold at the same weight.
...
- One movement with **arms down at your sides** (e.g. pressdown) → more lateral (outer) head.
- One movement with **arms overhead** → more long (inner) head.

## Loaded stretch finisher
Two 60-second flat dumbbell holds at ~40% of your 4-6 rep working weight. The rationale is combining **high metabolic stress** (long set duration) with a **high degree of stretch** at the bottom simultaneously. Experts disagree about the relative contribution of stretch versus metabolic stress to hypertrophy, but Jeff's view is that both occupy part of the puzzle. It also offers a novel overload variable: time under tension.

## Face pulls
Not strictly a push movement, but included for postural support and to prevent overdevelopment of the anterior musculature — a more balanced, upright look. You can run them on pull days instead; Jeff prefers push days to guarantee his pulling work keeps pace.
