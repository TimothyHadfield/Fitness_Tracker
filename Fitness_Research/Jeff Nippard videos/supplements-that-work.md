# The Five Supplements Worth Taking: Doses, Timing and Evidence
...
- **Caffeine** — **4 mg/kg before training**, cycled off **3–7 days every 1–2 months** to fight tolerance.
- **Citrulline malate** — **4–10 g about 1 hour before training**; more reps on later sets and less soreness, not just a pump product.
- **Multivitamin** (athlete-formulated) — one per day, especially in a caloric deficit.
- **Creatine monohydrate** — **3–5 g per day**, after training or whenever convenient. No loading, no cycling needed.
...
**Energy expenditure.** Lyle McDonald cites an extra **100 calories burned per 600 mg** of caffeine — a hefty daily dose. Even **300 mg** would still mean about **50 extra calories per day**, which adds up over time.
...
## Creatine
[07:39] Produced naturally in the body and found in meat and fish; a typical omnivorous diet supplies about **1 g/day**, well short of the supplemental dose needed to see benefits. Hundreds of studies support its efficacy and safety — Examine.com references a **strong effect on power output across 66 studies**.
...
**Dose: 3–5 g per day**, post-training or whenever convenient.

## Practical application
Daily stack for a trained lifter:
- Creatine monohydrate **3–5 g/day**, any time, every day, indefinitely.
- Athlete multivitamin **1/day**, non-negotiable while cutting.
- Whey (ideally whey/casein blend, mixed with milk) as needed to reach **~1 g protein per pound of body weight**.
- Pre-workout: **caffeine 4 mg/kg** + **citrulline malate 4–10 g**, both about an hour out. Optionally add theanine if caffeine disrupts sleep or focus.
- Cycle caffeine off for **3–7 days every 1–2 months**; never cycle creatine.

## Caveats & unknowns
- The whey-vs-casein question is still open in the literature; the blend recommendation is a reasoned hedge, not a settled finding.
- Up to ~30% of people may be creatine non-responders — test it on yourself rather than assuming.
- Caffeine tolerance is described as insurmountable, so the benefits are conditional on disciplined cycling or intermittent use.
- Nitrate for the pump lacks sufficient research; the 500–1,000 mg figure is a starting point, not an established dose.
- Ashwagandha would have been Nippard's #6 — shown to reduce stress and anxiety and improve mood — but it didn't make the top five.
- This is a 2017 video; supplement evidence has moved on since.
