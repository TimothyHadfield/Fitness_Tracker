# Science-Based Leg Workout, Day 2 (Push/Pull/Legs)

**Source:** Jeff Nippard, "The Most Effective Science-Based Leg Workout Pt. 2 (Quads, Glutes, Hams, Calves) | Science Applied" ([watch](https://www.youtube.com/watch?v=8sXVbOBFPig)) · 2018-09-03 · 11 min
**Topic:** Programming

## Bottom line
- This is the second lower-body session of a PPL week; each body part gets hit twice weekly because the literature favours 2x/week over 1x/week for growth.
- The session is built around a heavy sumo deadlift at RPE 6-7 (~75% 1RM), then deliberately pairs it with long-range-of-motion and eccentric-emphasis work to cover the deadlift's weaknesses.
- Deadlift criticisms (concentric-only, limited ROM, high recovery cost) are real but are solved by exercise pairing rather than by dropping the lift.
- Hip thrust is prescribed at a fixed 15 reps to force technique mastery before load; Jeff's benchmark is that your 1RM hip thrust should be at least as strong as your 1RM deadlift.
- Finishing with 3x30 hip abductions targets the glute medius — a muscle he considers badly neglected, especially by men.
...
|---|---|---|---|
| 1 | Deadlift (sumo) | 4 x 4 | RPE 6-7, roughly 75% 1RM. Don't approach failure. |
| 2 | Deficit Bulgarian split squat (Smith) | 3 x 10-12 | Or front squat — pick one. |
| 3 | Barbell hip thrust | 3 x 15 | Fixed rep count; add load only when RPE drops a point. |
| 4 | Goblet squat, 3-sec eccentric | 3 x 15 | Upright torso, knees travel forward freely. |
| 5 | Lying leg curl, enhanced eccentric | 3 x 10 | Partner-applied manual resistance on the negative. |
| 6 | Machine seated hip abduction | 3 x 30 | Metabolic stress, glute medius. |
| 7 | Standing calf raise | 3 x 10 | Pause stretched at the bottom, full press onto toes. |

## Deadlift: the case against, and the answers [01:31]
Three standard hypertrophy objections to the deadlift, and Jeff's responses:

1. **Concentric only.** Powerlifting-style deadlifts have essentially no eccentric — proper form is to guide the bar straight down with hands on the bar but without actively resisting the negative (slowing it deliberately raises injury risk in his experience). Since eccentric contractions appear more important than concentric for hypertrophy, this counts against the lift. *Answer:* pair it with eccentric-focused exercises later in the session, which this workout does twice.
2. **Limited range of motion.** Hips start higher than in a squat, so the bottom position is roughly a half squat. *Answer:* the bulk of evidence favours longer ROM, but some evidence suggests partial ROM training can produce similar results, and pairing with big-ROM exercises resolves it.
3. **Recovery cost.** *Answer:* depends on how heavy and how often. One floor deadlift session per week at submaximal loads should not impair other work for an intermediate-to-advanced lifter.

He adds a broader argument: muscle and strength adaptations are well correlated in the literature, deadlift strength carries over to other lifts, and building a strength base makes sense even for a pure hypertrophy goal.

**Sumo vs conventional** [04:34]: Jeff pulls sumo because he is ~50 lb stronger there. Borrowing from a Greg Nuckols article, there are really only two differences — sumo works the quads more, conventional taxes the spinal erectors more. The idea that sumo hits the glutes better is a misconception debunked by Brett Contreras's research; glute involvement is about the same.
...
**Standing calf raise, 3x10.** Stretch and pause at the bottom, press all the way up onto the toes. Barefoot is more comfortable for a true full ROM.

## Practical application
- Choose either the Bulgarian split squat or the front squat, not both.
- Don't grind the deadlift — 4x4 at RPE 6-7 is a strength-maintenance dose, not a max effort day.
- Use fixed-rep prescriptions on technically demanding lifts as a forcing function for form.
- No training partner? Double eccentric duration to 3-4 seconds instead of using manual resistance.
